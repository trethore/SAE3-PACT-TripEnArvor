...
('Atelier de Tissage Breton', 'Initiez-vous à l’art du tissage traditionnel breton.', 'Vannes', 'Participez à un atelier unique où vous apprendrez les bases du tissage breton avec un artisan local. Découvrez les techniques ancestrales et repartez avec votre création.', 'https://www.tissagebzh.com', 2, 3,'standard', 3, 120, 8);
