        ...
        try{
            switch ($_POST['type-compte']) {
                case 'membre':
                    ...
                    if ($tel === '') $tel = null;
                    $query = "INSERT INTO sae.compte_membre (nom_compte, prenom, email, tel, mot_de_passe, auth, pseudo) VALUES (?, ?, ?, ?, ?, FALSE, ?) RETURNING id_compte;";
                ...
                case 'pro-publique':
                    ...
                    $query = "INSERT INTO sae.compte_professionnel_publique (nom_compte, prenom, email, tel, mot_de_passe, auth, id_adresse, denomination, a_propos, site_web) VALUES (?, ?, ?, ?, ?, FALSE, ?, ?, ?, ?) RETURNING id_compte;";
                    $stmt = $dbh->prepare($query);
                ...
                case 'pro-privé':
                    ...
                    $stmt->execute([$street, $address_complement, $code_postal, $city, $country]);
                    $id_adresse = $stmt->fetch()['id_adresse'];
                    $query = "INSERT INTO sae.compte_professionnel_prive (nom_compte, prenom, email, tel, mot_de_passe, auth, id_adresse, denomination, a_propos, site_web, siren) VALUES (?, ?, ?, ?, ?, FALSE, ?, ?, ?, ?, ?) RETURNING id_compte;";
                    $stmt = $dbh->prepare($query);
