        ...
        <?php if (!$submitted) { ?>
            ...
            <main>
                ...
                <div>
                    ...
                    <br>
                    <!-- parc -->
                    <label id="labelnbattractions" for="nbattraction">Nombre d'attractions <span class="required">*</span> </label> <input type="number" id="nbattraction" name="attractions" value="<?php echo htmlentities($activite['capacite'] ?? ''); ?>"/>
