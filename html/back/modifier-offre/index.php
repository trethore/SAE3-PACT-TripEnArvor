                    ...
                    <div class="important">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="gammedeprix" placeholder="€ ou €€ ou €€€" pattern="^€{1,3}$" name="gammeprix" value="<?php if(getRestaurant($row['id_offre'])["gamme_prix"]){echo htmlentities(getRestaurant($row['id_offre'])["gamme_prix"]);} ?>" /></td>
                            </tr>
                            <tr>
