...
<body class="genFacture">
                    ...
                    if ($factAbos && is_array($factAbos)) {
                        ...
                        <tr>
                            ...
                            <?php // Calcul pour le total final
                                ...
                                $TotalTVA += (getOffreTTC($factAbo["prix_ht_jour_abonnement"],$nb_jour, $TVA)-$factAbo["prix_ht_jour_abonnement"]*$nb_jour);
                            ?>
                        </tr>
                    <?php }}
                } catch (PDOException $e) {
    ...
    <table class="totals">
        ...
        <tr>
            <td>Total TVA</td>
            <td><?php 
            $TotalTVA = $TotalTVA*($TVA/100);
            echo htmlentities(convertCentimesToEuros($TotalTVA)) ?? '' 
            ?></td>
        </tr>
        <tr>
            <td><b>Total TTC</b></td>
