    ...
    if (isset($id_offre)) {
        ...
        if (getOffre($id_offre)['nb_jetons'] < 3) {
            ...
            try {
                ...
                $reqUpdateJetonDate = "UPDATE sae._offre SET nb_jetons = :nb_jetons, jeton_perdu_le = NOW() AT TIME ZONE 'Europe/Paris' WHERE jeton_perdu_le <= NOW() AT TIME ZONE 'Europe/Paris' - INTERVAL '17 DAY' AND id_offre = :id_offre;";
